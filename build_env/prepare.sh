# export DIST_ROOT=/home/acth/CydraOS/
# export LFS=$DIST_ROOT/build_env/build_root

echo "File Dist Root: ${DIST_ROOT:?}"
echo "File LFS: ${LFS:?}"
...
do
    ...
    if ! test -f $LFS/sources/$bn ; then
        wget -nc --input-file="http://www.linuxfromscratch.org/lfs/view/stable/wget-list" --continue --directory-prefix=$LFS/sources -O $LFS/sources/$bn
    fi
